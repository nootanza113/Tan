...
cl = LINETCR.LINE()
cl.login(token="EpTnVQkW6mMZSD0dbnc3.2NgwL6jkJZ728bEP4WJn0W.yKMVo4UDYuaRptWVHYcuIe3z1Yl/PbZ8SKm419E1k+c=")
cl.loginResult()
...
helpMessage ="""     ─┅═✥हई さדさʅʅמゆईह✥═┅─

─┅═✥〖Ťäň〗s̵ᴇʟғ ʙᴏᴛ ᴛʜᴀɪʟᴀɴᴅ✥═┅─
...
targets = []
mid = cl.getProfile().mid
Bots = ["uda719697a24a8f3ef6f017a9e308cdd3",mid]
self = ["uda719697a24a8f3ef6f017a9e308cdd3",mid]
admin = "uda719697a24a8f3ef6f017a9e308cdd3"
admsa = "uda719697a24a8f3ef6f017a9e308cdd3"
owner = "uda719697a24a8f3ef6f017a9e308cdd3"
adminMID = "uda719697a24a8f3ef6f017a9e308cdd3"
Creator= "uda719697a24a8f3ef6f017a9e308cdd3"
wait = {
    "alwayRead":False,
    "detectMention":True,    
    "kickMention":False,
    ...
    'timeline':True,
    'autoAdd':False,
    'message':"Thanks for add Me MY NAME IS Tan",
    "lang":"JP",
    "comment":"AutoLike by Tan",
    "commentOn":False,
    "acommentOn":False,
    "bcommentOn":False,
    "ccommentOn":False,
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     ...
                     ret_ = "[อัตโนมัต] " + random.choice(balas)
...
#----------------------------------------------------------------------------
            ...
            elif msg.text in ["ของขวัญ","Gift","ติก"]:
                msg.contentType = 9
...
#==================================================
                ...
                cl.sendText(msg.to,"""[SELFBOT Tan BOT]\n\n
Tan. Bot
คำสั่งบอท siri
...
#==================================================
                ...
                cl.sendText(msg.to,""" 􀜁􀇔􏿿􀜁􀇔􏿿[{Tan BOT}] 􀜁􀇔􏿿􀜁􀇔􏿿 \n\n 􀜁􀇔􏿿 key Only Kicker 􀜁􀇔􏿿 \n\n􀜁􀇔􏿿[Kb1 in]\n􀜁􀇔􏿿[1Aditname:]\n􀜁􀇔􏿿[B Cancel]\n􀜁􀇔􏿿[kick @]\n􀜁􀇔􏿿[Ban @]\n􀜁􀇔􏿿[kill]\n􀜁􀇔􏿿[BotChat]\n􀜁􀇔􏿿[Respons]\n􀜁􀇔􏿿[Pb1 Gift]\n􀜁􀇔􏿿[Pb1 bye]\n\n
...
""")
                ...
                cl.sendText(msg.to,"[ชื่อของกลุ่ม]:\n" + str(ginfo.name) + "\n[Gid]:\n" + msg.to + "\n[ผู้สร้างกลุ่ม:]\n" + gCreator + "\n[ลิ้งค์รูปกลุ่ม]:\nhttp://dl.profile.line.naver.jp/0hnKqOolu-MWRMNh1YC39OM3BzPwk7GCAsIll6UGxjbgdlDn4zd1d9UWozOgdjVXI3dFArAGoxb1Ay/" + ginfo.pictureStatus + "\n[จำนวนสมาชิก]:" + str(len(ginfo.members)) + "คน\n[จำนวนค้างเชิญ]:" + sinvitee + "คน\n[สถานะลิ้งค์]:" + u + "URL [By: เหี้ย แทนไง]")            	
...
#===============================================
                ...
                ki.sendText(msg.to, "[SELFBOT  Tan]\n\n❂͜͡☆➣ Namelock on\n❂͜͡☆➣ Namelock off\n❂͜͡☆➣ Blockinvite on\n❂͜͡☆➣ Blockinvite off\n❂͜͡☆➣ Backup on\n❂͜͡☆➣ Backup off\n\n[By.แทนไงคัฟ]")
...
#-----------------------------------------------
                ...
                if msg.toType == 2:
                    ...
                    cl.sendText(msg.to,"[SELFBO TanHACK BOT]\n\nline://ti/g/" + gurl)
                else:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Can not be used outside the group")
                    else:
...
#-----------------------------------------------
                ...
                for g in gs.members:
                    if _nametarget == g.displayName:
                        ...
                        pass
#-------------------------------------------------
            elif msg.text in ["Tan All on","Tan all on"]:
                        cl.sendText(msg.to,"─┅══ईह ㏒ Tan ㏒ ईह══┅─\n\n[SELF BOT Tan ]")
                        cl.sendText(msg.to,"Please wait......")
            ...
            elif msg.text in ["Tan All off","Tan all off"]:
                        cl.sendText(msg.to,"─┅══ईह ㏒ Tan㏒ ईह══┅─\n\n[SELF BOT TanHACK BOT]")
                        cl.sendText(msg.to,"Please wait......")
            ...
            elif msg.text in ["ทีมงาน","ทีมยกบอท"]:
                msg.contentType = 13
                cl.sendText(msg.to, "[SELFBOT Tan]\n\n[दυथکπ➫ທี௮ઈπບმທ]\n[By.さדさʅʅמゆ]❞")
                cl.sendText(msg.to, "ผู้จัดการทีมงาน:ທี௮ઈπບმທ")
                msg.contentMetadata = {'mid': 'ua7872842a3becc26d000977982bba44b'}
                cl.sendMessage(msg)
                cl.sendText(msg.to, "รองผู้จัดการทีมงาน:ທี௮ઈπບმທ )
                msg.contentMetadata = {'mid': 'u3e684fb7a128216b104104a1a8085fcd '}
                cl.sendMessage(msg)
                cl.sendText(msg.to, "ประธาน:ທี௮ઈπບმທ")
                msg.contentMetadata = {'mid': 'uda719697a24a8f3ef6f017a9e308cdd3'}
                cl.sendMessage(msg)
                cl.sendText(msg.to, "ประธาน:ທี௮ઈπບმທ")
                msg.contentMetadata = {'mid': 'u205ee4596e9003bfcaf14c199ca5aa92'}
                cl.sendMessage(msg)
                cl.sendText(msg.to, "ประธาน:ທี௮ઈπບმທ ")
                msg.contentMetadata = {'mid': 'u1f2856887b3561a66c8b8b7bef5d5260'}
                cl.sendMessage(msg)
                cl.sendText(msg.to, "ประธาน:ທี௮ઈπບმທ")
                msg.contentMetadata = {'mid': 'uac9fc0daa07a73104b7705d911aabc01'}
...
#=============================================
            ...
            elif msg.text in ["Tanon","Autorespon:on","Respon on","Respon:on"]:
                wait["detectMention"] = True
                cl.sendText(msg.to,"Auto Respon ON")
                
            elif msg.text in ["Tanoff","Autorespon:off","Respon off","Respon:off"]:
        ...
        if op.type == 26:
            ...
            if msg.text.lower() in ["1123"]:
                ...
                if jml > 500:
                    cl.sendText(msg.to,'Member melebihi batas.')
                cnt = Message()
                cnt.text = "Tan TAG DONE : " + str(jml) +  " Members"
                cnt.to = msg.to
                cl.sendMessage(cnt)
            elif msg.text in [".me","me","Me"]:
                        cl.sendText(msg.to,"You..อะไร")
